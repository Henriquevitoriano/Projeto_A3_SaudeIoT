 ...
 * news2.js
 * -----------------------------------------------------------------------------
 * NOTA DE MANUTENÇÃO: este arquivo é uma CÓPIA EXATA do que existe em
 * alerts-service/src/news2.js. Mantemos cópia para o MVP. Em um refactor
 * futuro, isto viraria um pacote interno (@uti/news2) consumido pelos
 * dois serviços. A regra a seguir: qualquer mudança aqui deve ser refletida
 * lá, e vice-versa.
 * -----------------------------------------------------------------------------
